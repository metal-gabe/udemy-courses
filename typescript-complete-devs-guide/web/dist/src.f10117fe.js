...
var Eventing = /*#__PURE__*/_createClass(function Eventing() {
  ...
  this.on = function (eventName, cb) {
    ...
    var handlers = (_a = _this.events[eventName]) !== null && _a !== void 0 ? _a : [];
    handlers.push(cb);
...
var axios_1 = __importDefault(require("axios")); // Context / Store / Router
// Components / Classes / Controllers / Services


var Eventing_1 = require("./Eventing"); // Assets
// Constants / Models / Interfaces / Types
// Utils / Methods / Mocks
// Styles
      ...
      axios_1.default.get(this.rootUrl).then(function (response) {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _this.models.push(_this.deserialize(record));
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
...
var ApiSync = /*#__PURE__*/_createClass(function ApiSync(rootUrl) {
  var _this = this;
  ...
  this.fetch = function (id) {
    return axios_1.default.get("".concat(_this.rootUrl, "/").concat(id)); // .then((response: AxiosResponse) => {
  ...
  this.save = function (data) {
    ...
    if (id) {
      return axios_1.default.put("".concat(_this.rootUrl, "/").concat(id), data); // .then((response: AxiosResponse) => {
      ...
      return axios_1.default.post(_this.rootUrl, data); // .then((response: AxiosResponse) => {
...
var Attributes = /*#__PURE__*/function () {
  function Attributes(data) {
    ...
    this.set = function (newValues) {
      ...
      Object.assign(_this.data, newValues); // this.data = { ...this.data, ...newValues };
    };
  }
  ...
  _createClass(Model, [{
    ...
    value: function fetch() {
      ...
      this.sync.fetch(id).then(function (response) {
        console.info("Successfully fetched user with ID #".concat(id), {
          response: response
        });

        _this.set(response.data);
      }).catch(function (error) {
        console.error("There was a problem retrieving the user info for ID #".concat(id, "."), {
          error: error
        });
      });
    }
    ...
    value: function save() {
      ...
      this.sync.save(this.attributes.getAll()).then(function (response) {
        console.info('Successfully saved the user', {
          response: response
        });

        _this2.trigger('save');
      }).catch(function (error) {
        console.error('There was a problem saving the user', {
          error: error
        });
...
exports.User = exports.ROOT_URL = void 0;
/* ========================================================================== */
// ALL REQUIRED IMPORTS
...
var Model_1 = require("./Model"); // Utils / Methods / Mocks
// Styles
...
exports.ROOT_URL = 'http://localhost:3000/users';
/* ========================================================================== */
...
var User = /*#__PURE__*/function (_Model_1$Model) {
  ...
  _createClass(User, [{
    ...
    value: function buildUser(attrs) {
      return new User(new Attributes_1.Attributes(attrs), new Eventing_1.Eventing(), new ApiSync_1.ApiSync(exports.ROOT_URL));
    }
  }, {
    key: "buildUserCollection",
    value: function buildUserCollection() {
      return new Collection_1.Collection(exports.ROOT_URL, User.buildUser);
    }
  }]);
...
exports.CollectionView = void 0; // Utils / Methods / Mocks
// Styles
...
exports.View = void 0; // Utils / Methods / Mocks
// Styles
    ...
    value: function bindEvents(fragment) {
      ...
      var _loop = function _loop(eventKey) {
        ...
        fragment.querySelectorAll(selector).forEach(function (element) {
          element.addEventListener(eventName, _this.eventsMap[eventKey]);
        });
      };
...
var View_1 = require("./View"); // Utils / Methods / Mocks
// Styles
...
var UserShow_1 = require("./UserShow"); // Utils / Methods / Mocks
// Styles
...
var UserList_1 = require("./views/UserList"); // Utils / Methods / Mocks
// Styles
...
var users = new Collection_1.Collection(User_1.ROOT_URL, function (userData) {
  return User_1.User.buildUser(userData);
});
...
/* ========================================================================== */
},{"./models/Collection":"src/models/Collection.ts","./models/User":"src/models/User.ts","./views/UserList":"src/views/UserList.ts"}],"../../../../../../.nodenv/versions/16.14.2/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../../../../.nodenv/versions/16.14.2/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/index.ts"], null)
